$(document).ready(function () {
    ...
    */
    function isFilled() {
        ...
        */
        ...
        var dept = validator.trim($('#dept').val());
        ...
        */
        ...
        var deptEmpty = validator.isEmpty(dept);
        var emailEmpty = validator.isEmpty(email);
        var pwEmpty = validator.isEmpty(pw);

        return !fNameEmpty && !lNameEmpty && !deptEmpty && !emailEmpty && !pwEmpty;
    }
    ...
    */
    ...
    /*
        ...
        This also calls functions isFilled(), and isValidPassword()
    ...
    */
    ...
    $('#dept').keyup(function () {
        ...
        validateField($('#dept'), 'Department', $('#deptError'));
    });
